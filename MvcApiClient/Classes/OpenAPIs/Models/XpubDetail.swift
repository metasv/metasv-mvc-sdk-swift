...
public struct XpubDetail: Codable {
    ...
    public var processHeight: Int64?

    public init(xpub: String? = nil, receiveIndex: Int? = nil, maxReceiveIndex: Int? = nil, changeIndex: Int? = nil, maxChangeIndex: Int? = nil, mode: Int? = nil, skipHeight: Int64? = nil, processHeight: Int64? = nil) {
        self.xpub = xpub
