...
public struct OutputInfo: Codable {
    ...
    public init(txid: String? = nil, index: Int? = nil, address: String? = nil, value: Int64? = nil, spent: Bool? = nil, spentTxid: String? = nil, spentIndex: Int? = nil, spentHeight: Int64? = nil) {
        self.txid = txid
        self.index = index
