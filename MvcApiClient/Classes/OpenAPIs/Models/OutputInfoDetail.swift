...
public struct OutputInfoDetail: Codable {
    ...
    public var spentHeight: Int64?

    public init(txid: String? = nil, index: Int? = nil, script: String? = nil, address: String? = nil, value: Int64? = nil, spent: Bool? = nil, spentTxid: String? = nil, spentIndex: Int? = nil, spentHeight: Int64? = nil) {
        self.txid = txid
        self.index = index
        self.script = script
