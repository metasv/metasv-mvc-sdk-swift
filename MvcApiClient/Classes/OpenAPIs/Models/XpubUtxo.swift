...
public struct XpubUtxo: Codable {
    ...
    public init(xpub: String? = nil, address: String? = nil, addressType: Int? = nil, addressIndex: Int? = nil, txid: String? = nil, txIndex: Int? = nil, value: Int64? = nil, height: Int64? = nil, flag: Int64? = nil) {
        self.xpub = xpub
