...
public struct ContractUniqueUtxo: Codable {
    ...
    public init(txid: String? = nil, txIndex: Int? = nil, codeHash: String? = nil, genesis: String? = nil, sensibleId: String? = nil, height: Int64? = nil, customData: String? = nil, satoshi: Int64? = nil, satoshiString: String? = nil) {
        self.txid = txid
