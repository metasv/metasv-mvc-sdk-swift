...
open class XpubAPI {
     ...
     */
    open class func xpubLiteXpubAddressAddressGet(xpub: String, address: String, apiResponseQueue: DispatchQueue = MvcApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: XpubAddress?,_ error: Error?) -> Void)) {
    ...
    open class func xpubLiteXpubAddressAddressGetWithRequestBuilder(xpub: String, address: String) -> RequestBuilder<XpubAddress> {
        ...
        let requestBuilder: RequestBuilder<XpubAddress>.Type = MvcApiClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func xpubLiteXpubBalanceGet(xpub: String, apiResponseQueue: DispatchQueue = MvcApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: XpubLiteBalance?,_ error: Error?) -> Void)) {
    ...
    open class func xpubLiteXpubBalanceGetWithRequestBuilder(xpub: String) -> RequestBuilder<XpubLiteBalance> {
        ...
        let requestBuilder: RequestBuilder<XpubLiteBalance>.Type = MvcApiClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func xpubLiteXpubUtxoGet(xpub: String, limit: Int? = nil, apiResponseQueue: DispatchQueue = MvcApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [XpubUtxo]?,_ error: Error?) -> Void)) {
    ...
    open class func xpubLiteXpubUtxoGetWithRequestBuilder(xpub: String, limit: Int? = nil) -> RequestBuilder<[XpubUtxo]> {
        ...
        let requestBuilder: RequestBuilder<[XpubUtxo]>.Type = MvcApiClientAPI.requestBuilderFactory.getBuilder()
