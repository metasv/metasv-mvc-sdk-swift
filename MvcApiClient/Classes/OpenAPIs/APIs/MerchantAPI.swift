...
open class MerchantAPI {
     ...
     */
    open class func merchantUtxoPost(utxoPickRequest: UtxoPickRequest? = nil, apiResponseQueue: DispatchQueue = MvcApiClientAPI.apiResponseQueue, completion: @escaping ((_ data: [AddressUtxo]?,_ error: Error?) -> Void)) {
