...
public struct ContractFtUtxo: Codable {
    ...
    public init(address: String? = nil, codeHash: String? = nil, genesis: String? = nil, name: String? = nil, symbol: String? = nil, sensibleId: String? = nil, decimal: Int? = nil, txid: String? = nil, txIndex: Int? = nil, value: Int64? = nil, valueString: String? = nil, satoshi: Int64? = nil, satoshiString: String? = nil, height: Int? = nil, flag: String? = nil) {
