...
public struct BlockHeader: Codable {
    ...
    public var inputCount: Int64?
    /** Total output count in the block */
    public var outputCount: Int64?
    /** Size of the block */
    ...
    public init(height: Int64? = nil, blockHash: String? = nil, version: Int64? = nil, prevBlockHash: String? = nil, merkleRoot: String? = nil, timestamp: Int64? = nil, medianTime: Int64? = nil, reward: Int64? = nil, miner: String? = nil, minerAddress: String? = nil, txCount: Int64? = nil, inputCount: Int64? = nil, outputCount: Int64? = nil, size: Int64? = nil, bits: Int64? = nil, nonce: Int64? = nil, coinbase: String? = nil) {
        self.height = height
