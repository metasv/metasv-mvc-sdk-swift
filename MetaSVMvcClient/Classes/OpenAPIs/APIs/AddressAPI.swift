...
open class AddressAPI {
     ...
     */
    open class func addressAddressBalanceGet(address: String, apiResponseQueue: DispatchQueue = MetaSVMvcClientAPI.apiResponseQueue, completion: @escaping ((_ data: AddressBalance?,_ error: Error?) -> Void)) {
    ...
    open class func addressAddressBalanceGetWithRequestBuilder(address: String) -> RequestBuilder<AddressBalance> {
        ...
        let requestBuilder: RequestBuilder<AddressBalance>.Type = MetaSVMvcClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addressAddressTxGet(address: String, flag: String? = nil, confirmed: Bool? = nil, apiResponseQueue: DispatchQueue = MetaSVMvcClientAPI.apiResponseQueue, completion: @escaping ((_ data: [AddressTx]?,_ error: Error?) -> Void)) {
    ...
    open class func addressAddressTxGetWithRequestBuilder(address: String, flag: String? = nil, confirmed: Bool? = nil) -> RequestBuilder<[AddressTx]> {
        ...
        let requestBuilder: RequestBuilder<[AddressTx]>.Type = MetaSVMvcClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addressAddressUtxoGet(address: String, flag: String? = nil, apiResponseQueue: DispatchQueue = MetaSVMvcClientAPI.apiResponseQueue, completion: @escaping ((_ data: [AddressUtxo]?,_ error: Error?) -> Void)) {
