...
open class OutpointAPI {
     ...
     */
    open class func outpointTxidIndexGet(txid: String, index: Int, apiResponseQueue: DispatchQueue = MetaSVMvcClientAPI.apiResponseQueue, completion: @escaping ((_ data: OutputInfo?,_ error: Error?) -> Void)) {
    ...
    open class func outpointTxidIndexGetWithRequestBuilder(txid: String, index: Int) -> RequestBuilder<OutputInfo> {
        ...
        let requestBuilder: RequestBuilder<OutputInfo>.Type = MetaSVMvcClientAPI.requestBuilderFactory.getBuilder()
